...
public interface ComptabiliteDao {
    ...
    void insertSequence(SequenceEcritureComptable sequenceEcritureComptable, String code);

    SequenceEcritureComptable getSequenceEcritureComptable(int annee, String code) throws NotFoundException;

    void updateSequenceEcritureComptable(SequenceEcritureComptable sequenceEcritureComptable,
                                                              String code);

    void deleteSequenceEcritureComptable(int annee, String code, int derniereValeur);
}
